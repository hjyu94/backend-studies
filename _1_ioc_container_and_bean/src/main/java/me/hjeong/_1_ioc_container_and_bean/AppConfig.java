...
@Configuration
@ComponentScan(basePackages = "me.hjeong._1_ioc_container_and_bean")
class AppConfig2 {
    @Bean
    public BookRepository bookRepository() {
        return new BookRepository();
...
// setter나 arguemnt로 의존성을 주입하는 것이 귀찮다면
// @ComponentScan + 의존성이 필요한 부분에서 @Autowired 써주기
// 로 편리하게 의존성을 주입시킬 수 있다.